// Code generated from kem.templ.go. DO NOT EDIT.
...
// described in
//
// https://classic.kem.org/nist/mceliece-20201010.pdf
//
...
func encapsulate(pk kem.PublicKey, rand randFunc) (ct, ss []byte, err error) {
	...
	err = kemEncapsulate(&ciphertext, &sharedSecret, (*[PublicKeySize]byte)(ppk), rand)
	if err != nil {
		return nil, nil, err
	}
...
func (*scheme) Decapsulate(sk kem.PrivateKey, ct []byte) ([]byte, error) {
	...
	err := kemDecapsulate(&ss, (*[CiphertextSize]byte)(ct), (*[PrivateKeySize]byte)(ssk))
	if err != nil {
		return nil, err
	}
	return ss[:], nil
